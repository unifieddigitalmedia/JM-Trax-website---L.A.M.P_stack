...
$http.get("http://192.168.0.90/intranet/api/transactions.php?agentusername="+ getCookie('agentusername')+"&agenttype="+getCookie('agenttype')).then(function(response) {
...
window.location = "http://192.168.0.90/intranet/editorder.html" ;
